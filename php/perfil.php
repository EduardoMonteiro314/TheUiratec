...
<body>
    ...
    <div id="conteudo">
        <div id="perfil-section">
            ...
            <button id="criarPost" onclick="escreverPensamento()">Criar post</button>
            <a href="#" id="sair" onclick="trocalModalSair()">Sair</a>
        </div>
    ...
    <div id="modal">
        <form id="caixaCriarPost" method="POST">
            <div id="corVoltar">
                <div id="voltar" onclick="escreverPensamento()">X</div>
                <div id="escolherCor">
    ...
    <div id="modalSair" class="modalOpcao">
        <div class="conteudo-modal">
            ...
            <div class="buttons">
                <button id="btnSair" onclick="sair()">Sim</button>
    ...
    <div id="modalApagar" class="modalOpcao">
        <div class="conteudo-modal">
            ...
            <div class="buttons">
                ...
                <button onclick="fecharModalApagar()">Não</button>
            </div>
        </div>
    </div>
